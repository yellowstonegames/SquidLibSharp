...
namespace SquidLib.SquidMisc {

    /// <summary>
    /// Extends KeyValuePair to be named decomposable for easier handling.
    /// </summary>
    ...
    /// <summary>
    /// Misc utilities methods and fields pulled from Epigon and such.
    /// </summary>
    public static class Utils {
        ...
        public static readonly char[] EighthBlocks = new char[] { ' ', '▁', '▂', '▃', '▄', '▅', '▆', '▇', '█' };
        public static readonly string[] BrailleByDots = {
        "⠀",
        "⠁⠂⠄⠈⠐⠠⡀⢀",
        "⠃⠅⠆⠉⠊⠌⠑⠒⠔⠘⠡⠢⠤⠨⠰⡁⡂⡄⡈⡐⡠⢁⢂⢄⢈⢐⢠⣀",
        "⠇⠋⠍⠎⠓⠕⠖⠙⠚⠜⠣⠥⠦⠩⠪⠬⠱⠲⠴⠸⡃⡅⡆⡉⡊⡌⡑⡒⡔⡘⡡⡢⡤⡨⡰⢃⢅⢆⢉⢊⢌⢑⢒⢔⢘⢡⢢⢤⢨⢰⣁⣂⣄⣈⣐⣠",
        ...
        public static string Caps(string original) {
            ...
            return original.Split((char[])null)
        ...
        //    Color[][] cs = ArrayTools.Create<Color>(8, innerSize);
        //    for (int i = 0; i < 8; i++) {
        ...
        public static Coord FindCentroid(List<Coord> coords) {
            if (coords is null) {
                throw new ArgumentNullException(nameof(coords), "List of Coord must not be null.");
            }
            if (coords.Count == 0) {
                throw new ArgumentException("Must have at least one Coord.");
            }
            int centroidX = 0;
            int centroidY = 0;
            foreach (Coord c in coords) {
            ...
            centroidX /= coords.Count;
            centroidY /= coords.Count;
        ...
        //        lines.addAll(Bresenham.line2D(points[i], points[(i + 1) % points.length]));
        //    }
        //    return lines;
        //}
        ...
        //        region.addAll(Bresenham.line2D(points.get(i), points.get((i + 1) % points.size())));
        //    }
        //    //        GreasedRegion lines = region.copy();
        ...
        //public static bool pointsInLine(GreasedRegion points) {
        //    int sz = points.size();
        //    if (sz < 3) {
        ...
        public static readonly string UsableCharacters =
        ...
        /*
         *  public readonly string[] logo = new string[]{
                "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::",
                "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::",
                "::'######:::'#######::'##::::'##:'####:'########::'##:::::::'####:'########:::",
                ":'##... ##:'##.... ##: ##:::: ##:. ##:: ##.... ##: ##:::::::. ##:: ##.... ##::",
