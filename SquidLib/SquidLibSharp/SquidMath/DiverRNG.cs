    ...
    public sealed class DiverRNG : IStatefulRNG {
        ...
        public DiverRNG() :
            this((long)((localRNG.NextDouble() - 0.5) * 0x10000000000000L)
                    ^ (long)(((localRNG.NextDouble() - 0.5) * 2.0) * 0x8000000000000000L)) { }
        ...
        public DiverRNG(String seed) => state = (ulong)seed.GetHashCode(); // WAS - CrossHash.hash64(seed);
        ...
        public float nextFloat() {
            ulong z = (state = (state ^ 0x6C8E9CF570932BD5L) * 0xC6BC279692B5CC83L);
            return ((z << 27 | z >> 37) * 0xDB4F0B9175AE2165L >> 40) * 0x1e - 24f;
        }
        ...
        public void setState(long seed) => state = (ulong)seed;

        public long getState() => (long)state;
